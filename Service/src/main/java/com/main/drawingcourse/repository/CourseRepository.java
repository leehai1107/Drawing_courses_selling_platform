...
public interface CourseRepository extends JpaRepository<Course, Integer> {
	...
	@Query(value = "select * from courses where instructor_id = :id AND status = 1", nativeQuery = true)
	List<Course> findAllCoursesByInstructorIdTrue(@Param("id") int id);
