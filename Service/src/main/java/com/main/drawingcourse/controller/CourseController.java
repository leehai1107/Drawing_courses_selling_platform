...
public class CourseController {
	...
	@GetMapping("/find-by-InstructorIdTrue/{id}")
	public List<ResponseCourse> getCoursesByInstructorIdTrue(@PathVariable int id) {
		return CourseService.findCourseByInstructorIDTrue(id);
	}
